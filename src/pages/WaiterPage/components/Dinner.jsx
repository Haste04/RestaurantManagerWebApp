...
const Dinner = ({ onAddOrder }) => {
  const [selectedItem, setSelectedItem] = useState(null);
  const [quantity, setQuantity] = useState(1);

  const dinnerImages = import.meta.glob("../../../assets/dinner/*", {
    eager: true,
  });
  const images = Object.fromEntries(
    Object.entries(dinnerImages).map(([path, module]) => {
  ...
  const dinnerItems = [
    { id: 9, name: "Adobo", price: 150.12, image: images["adobo.jpg"] },
    { id: 10, name: "Kawali", price: 67.12, image: images["kawali.webp"] },
    { id: 11, name: "Lumpia", price: 4000.67, image: images["lumpia.jpg"] },
    { id: 12, name: "Sinigang", price: 6767.67, image: images["sinigang.jpg"] },
  ];
